...
from app.routers.job_requirement import router as job_requirements_router

from app.routers.job_matching import router as job_matching_router
...
app.include_router(job_recommendations)